...
public class Service implements Observable<UserChangeEvent> {
    ...
    final private MessageRepositoryDatabase repo3;
    ...
    public Service(UserRepositoryDatabase repo1, Validator validare, FriendRepositoryDatabase repo2,MessageRepositoryDatabase repo3)
    {
        this.repo1 = repo1;
    ...
    public void addMessageService(int idSender,int idReceiver,String text,LocalDateTime data)
    {
        Message mesajToBeAdd = new Message(idSender,idReceiver,text,data);
        repo3.save(mesajToBeAdd);
    }
    public void deleteMessageService(int idSender,int idReceiver,String text,LocalDateTime data)
    {
        Message mesajToBeDeleted = new Message(idSender,idReceiver,text,data);
        repo3.delete(mesajToBeDeleted);
    }
