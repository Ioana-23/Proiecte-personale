...
public class Main {
    public static void main(String[] args)
    {
        ...
        MessageRepositoryDatabase repo3 = new MessageRepositoryDatabase("jdbc:postgresql://localhost:5432/Lab4","postgres","postgres");
        Validator val = new Validator();
        Service serv = new Service(repo1,val, repo2,repo3);
